...
/**
 * IT-F006-006（部分, 山月記(000624)分のみ）: F006 work単位atomic受入。
 * 実プロジェクトの永続化済みcanonical artifact（山月記は本T-151で既にaccepted済み）
 * を対象に、prepareF006WorkAcceptance/acceptF006Work/recoverF006WorkAcceptanceが
 * mock無しの実データで冪等に動作すること、およびallowlist/work順違反を拒否する
 * ことを検証する。名人伝・弟子(T-152/T-153)分はpending残のため、
...
const ACCEPTED_WORK_ID = '000624' as WorkId;
const PENDING_WORK_ID = '000621' as WorkId;
